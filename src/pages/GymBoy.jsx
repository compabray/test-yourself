...
function GymBoy () {
    ...
    const questions = [
        ...
        "Do you weigh more than 200lb?",
        "Can you bench 315lb or more?",
        "Can you squat 405lb or more?",
        "Can you deadlift 550lb or more?",
    ...
    return (
        <div>
            <Template gender={"bro"} questions={questions} title={title} description={description}/>
        </div>
    )
}
