...
function Rice(){
    const questions =  ["Held hands romantically?",
    "Been on a date?",
    ...
    const title = "Rice purity test";
    const description = "Rice purity test was a test created by rice university, to evaluate their students, basically if you get 100 you are very pure and if you get a 0 you are so unholy."
